...
* [ENHANCEMENT] Store-gateway: Add the experimental ability to load TSDB index headers in a dedicated thread pool. This feature can be configured using `-blocks-storage.bucket-store.index-header-thread-pool-size` and is disabled by default. #TBD #1660 #1812
